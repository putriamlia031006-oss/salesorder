    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
               ...
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="d-none d-lg-flex align-items-center mr-2" style="text-align:right;">
                    <div>
                        ...
                        <br>
                        <span style="font-size:11px; color:#C9A86A; font-weight:600;">
                ...
                <div style="width:38px; height:38px; border-radius:50%;
                            background: linear-gradient(135deg, #C9A86A, #C9A86A);
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <!-- Header Dropdown -->
                <div class="px-3 py-2" style="background:#C9A86A; border-radius:12px 12px 0 0;">
                    ...
                    <div class="text-muted" style="font-size:11px;">
                        ...
                        &bull;
                        <span style="color:#C9A86A; font-weight:600;">
                            <?= ucfirst($this->session->userdata('role')) ?>
                        </span>
                    </div>
                </div>
                ...
                <a class="dropdown-item py-2" href="#">
                    <i class="fas fa-user fa-sm fa-fw mr-2" style="color:#C9A86A;"></i>
                    Profil Saya
                </a>
                ...
                <div class="dropdown-item text-muted py-1" style="font-size:11px; cursor:default;">
                    <i class="fas fa-clock fa-sm mr-1" style="color:#C9A86A;"></i>
                ...
                <a class="dropdown-item py-2" href="<?= site_url('auth/logout') ?>"
                   ...
                   style="color:#C9A86A; font-weight:600;">
